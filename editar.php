...
<div class="col-md-8">
                  <div class="card">
                      ...
                      <div class="mb-3">
                                <label class="form"  name="txtid">Identificador de Acta: <?php echo $row['id']  ?></label>
                                <input type="hidden"  class="form-control" name="txtid" placeholder="Area" value="<?php echo $row['id']  ?>">
                            </div>
                            <div class="mb-3">
